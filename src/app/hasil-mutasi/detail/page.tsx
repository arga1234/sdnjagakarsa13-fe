...
const initialData: Student[] = [
  {
    ...
    lulus: true,
    docLink:
      'https://drive.google.com/drive/folders/1AXhQb-4-mWEXEC_WxC1Lpqog8Sv-RjSk',
  },
  {
    no: 2,
    ...
    lulus: true,
    docLink:
      'https://drive.google.com/drive/folders/1AcIjR-TtEzn1WJUo8wNvclhIlvCEaj-h',
  },
  {
    no: 3,
    ...
    lulus: true,
    docLink:
      'https://drive.google.com/drive/folders/1AcevJ5LFq5gUn65BGHpJwJ6UNDj3u5V7',
  },
  {
    no: 4,
    ...
    lulus: false,
    docLink:
      'https://drive.google.com/drive/folders/1AhuZIZMDGgbqmBU_qWTWggXYoqeSG1bG',
  },
  {
    no: 5,
    ...
    lulus: false,
    docLink:
      'https://drive.google.com/drive/folders/1AYRzN_2Kjqrynna_JAvSkgiA0HL_g2cS',
  },
];
    ...
    <>
      ...
      <div className="container">
        <div className="emoji-wrapper">
          <span className="emoji" style={{ left: '10%', animationDelay: '0s' }}>
            🎈
          </span>
          <span
            className="emoji"
          ...
          <span className="emoji" style={{ left: '50%', animationDelay: '3s' }}>
            🤩
          </span>
          <span
            className="emoji"
          ...
          <span className="emoji" style={{ left: '90%', animationDelay: '6s' }}>
            🚀
          </span>
        </div>
